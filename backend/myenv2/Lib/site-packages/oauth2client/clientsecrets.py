...
def loadfile(filename, cache=None):
    ...
    * ``set(key, value, namespace=ns)``
    ...
    if not cache:
        return _loadfile("C:\\Users\\patoa\\Documents\\U\\Ingeniería web\\proyectoweb2.0-master\\backend\\proyectodjango\\credenciales\\client_secrets.json")

    obj = cache.get(filename, namespace=_SECRET_NAMESPACE)
    if obj is None:
        client_type, client_info = _loadfile("C:\\Users\\patoa\\Documents\\U\\Ingeniería web\\proyectoweb2.0-master\\backend\\proyectodjango\\credenciales\\client_secrets.json")
